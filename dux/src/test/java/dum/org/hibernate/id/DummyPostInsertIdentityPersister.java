...
public class DummyPostInsertIdentityPersister implements PostInsertIdentityPersister {
	...
	public void setRootTableKeyColumnNames(String[] rootTableKeyColumnNames) {
		this.rootTableKeyColumnNames = rootTableKeyColumnNames;
	}
