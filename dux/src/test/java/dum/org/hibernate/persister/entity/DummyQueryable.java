...
public class DummyQueryable implements Queryable {
	...
	public Type toType(String propertyName) throws QueryException {
		if (toTypeRWA != null) {
			return toTypeRWA.run(propertyName);
		}
		return null;
	}

	public void setToTypeRWA(RunnableWithArgs<Type> toTypeRWA) {
		this.toTypeRWA = toTypeRWA;
	}
