...
public class DummySessionFactoryBuilderImplementor extends TestEventCollector
	...
	public void markAsJpaBootstrap() {
		testEvents.add(new TestEvent("markAsJpaBootstrap"));
	}

	@Override
	public void disableJtaTransactionAccess() {
		testEvents.add(new TestEvent("disableJtaTransactionAccess"));
	}
