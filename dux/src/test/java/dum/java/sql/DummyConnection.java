...
public class DummyConnection extends TestEventCollector implements Connection {
	...
	public boolean getAutoCommit() throws SQLException {
		if (getAutoCommitException != null) {
			throw getAutoCommitException;
		}
		return autoCommit;
	}
	...
	public void setCommitException(SQLException commitException) {
		this.commitException = commitException;

	}

	public void setGetAutoCommitException(SQLException getAutoCommitException) {
		this.getAutoCommitException = getAutoCommitException;
